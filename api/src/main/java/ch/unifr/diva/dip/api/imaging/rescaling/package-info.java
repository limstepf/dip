 ...
 *
 * <li>The Bresenham algorithm (implemented in {@code FxBresenham} to directly
 * operate on JavaFX images) is pretty much equivalent to {@code AwtRescaling}
 * with NN rendering hint.</li>
 *
