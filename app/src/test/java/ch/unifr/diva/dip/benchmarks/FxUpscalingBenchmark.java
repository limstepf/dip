...
//			image = BenchmarkUtils.newRandomFxImage(960, 540);
	...
	@BenchmarkMode({Mode.AverageTime})
	@OutputTimeUnit(TimeUnit.MILLISECONDS)
	public WritableImage bresenhamAwt(Resources r) {
		final BufferedImage bimage = SwingFXUtils.fromFXImage(r.image, null);
		final BufferedImage scaled = AwtRescaling.bresenham(bimage, null, r.scale, r.scale);
