...
# options
benchmark_csvfile = 'FxUpscalingBenchmark-20160825_171254.csv'
benchmark_prefix = 'ch.unifr.diva.dip.benchmarks.FxUpscalingBenchmark.'
...
fig = plt.figure()
ax = pd.pivot_table(df, values='Score', columns='Benchmark', index='Param: scale').plot(
    figsize=plt_figsize, 
    logy=True, logx=True,
    style='x-'
)
