# -*- coding: utf-8 -*-
"""
IcoFont CSS to Java Enum. Extracts named glyphs from the
official CSS file.
...
# configuration
inputFile = './icofont.css'
outputFile = './extract-icofont-glyphs.java'


# regex pattern to parse icofont.css line by line using
# match (i.e. from the beginning of the line!)
glyphPattern = re.compile('\.icofont-([\w-]*):before')
...
# since we're getting rid of the '.icofont' prefix, we might end up with
