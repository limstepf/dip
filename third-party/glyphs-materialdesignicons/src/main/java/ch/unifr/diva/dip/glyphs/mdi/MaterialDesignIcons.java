package ch.unifr.diva.dip.glyphs.mdi;
...
/**
 * MaterialDesignIcons glyphs.
 *
 * @see
 * <a href="https://materialdesignicons.com/">https://materialdesignicons.com/</a>
 */
public enum MaterialDesignIcons implements NamedGlyph {

	/*
	 * use the `extract-materialdesignicons-glyphs.py` script (in the resource
	 * folder, right next to the TTF file) to create an up-to-date list of named
	 * glyphs from the official CSS file.
	 *
	 * Current version used: Material Design Icons 1.6.50,
	 * with 1650 glyphs (all unique).
	 */
	ACCESS_POINT('\uf002'),
	...
	private static String FONT_FAMILY = "Material Design Icons";
	private static String TTF = "/materialdesignicons-webfont.ttf";
	 ...
	 */
	MaterialDesignIcons(char character) {
	...
	protected static synchronized void load() {
		if (!isLoaded) {
			Font.loadFont(
					MaterialDesignIcons.class.getResource(TTF).toExternalForm(),
					DEFAULT_SIZE
			);
			isLoaded = true;
		}
